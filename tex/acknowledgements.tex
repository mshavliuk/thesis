...
Finally, thank you to you, the reader, for your interest in this thesis. I hope you find it informative and inspiring. For further details on the implementation and code design, please refer to the project's GitHub repository \citeurl{thesiscode}, which I hope will serve as a helpful resource in your own work. In case of any updates to the thesis document, the latest version can be found at \url{https://github.com/mshavliuk/thesis/releases/latest}.
